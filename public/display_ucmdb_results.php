        ...
        <div class="header cmdb">
            <div class="headerContent">
                ...
                <div class="searchContainer">
                    <form action="display_ucmdb_results.php" method="GET">
                        <div class="searchBarContainer">
                            <input type="hidden" name="type" value="<?php echo $type; ?>">
                            <input class="searchBox" id="autocomplete_input" type="text" name="term" placeholder="Введите имя сервера" value="<?php echo $printTerm; ?>" autocomplete="off">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="operatorsDefault">
                                        В данной системе (uCMDB Search), можно искать только сервер с полным именем в формате <kbd>s-msk-p-appsd</kbd><br>
                                        Попробуйте для примера (можно кликнуть на надпись): <a href="http://s-msk-p-appsd.raiffeisen.ru/routing/display_ucmdb_results.php?type=ucmdb&term=s-msk-p-appsd"><kbd>s-msk-p-appsd</kbd></a> или <a href="http://s-msk-p-appsd.raiffeisen.ru/routing/display_ucmdb_results.php?type=ucmdb&term=s-msk-p-smeta"><kbd>s-msk-p-smeta</kbd></a>
                                    </div>
                                </div>
